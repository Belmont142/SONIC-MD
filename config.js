...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'The Fallen 𝐁𝐨𝐭𝐭𝐨' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Rihito Bahha' : process.env.OWNER_NAME,
